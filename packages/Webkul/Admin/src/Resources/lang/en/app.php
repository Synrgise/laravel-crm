...
return [
    ...
    'clients' => [
        'index' => [
            'title' => 'Clients',
            'empty' => 'No clients yet. Clients are created when you close a deal as won.',
            'datagrid' => [
                'id'             => 'ID',
        ...
        'view' => [
            ...
            'add-contract'     => 'Add Contract / Agreement',
            'add-sla'          => 'Add SLA',
            'no-contracts'     => 'No contracts or agreements.',
            'no-slas'          => 'No SLAs defined.',
            'sla-name'          => 'SLA Name',
            'sla-document'      => 'SLA Document',
            'sla-document-hint' => 'PDF, DOC, DOCX or TXT. Max 10 MB.',
            'contract-name'     => 'Name',
            'contract-type'    => 'Type',
            'start-date'       => 'Start Date',
            'end-date'         => 'End Date',
            'contract-document'     => 'Contract document',
            'contract-document-hint'=> 'PDF, DOC, DOCX or TXT. Max 10 MB.',
            'response-time'    => 'Response (hours)',
            'resolution-time'  => 'Resolution (hours)',
            'terms'            => 'Terms',
            'cancel'           => 'Cancel',
            'save-sla'         => 'Save SLA',
            'documents'        => 'Uploaded Documents',
            'no-documents'     => 'No uploaded documents.',
            'download'         => 'Download',
            'download-document'=> 'Download document',
            'review-contract'  => 'Review',
            'actions'          => 'Actions',
            'close'            => 'Close',
            'delete-contract-confirm' => 'Delete this contract?',
            'leads'            => 'Leads',
            'view-leads'       => 'View all leads',
            'leads-count'      => ':count lead(s) for this organization.',
        ],
        'leads' => [
            'title'         => 'Leads – :name',
            'breadcrumb'    => 'Leads',
            'back-to-client' => 'Back to Client',
            'no-leads'      => 'No leads for this organization.',
            'lead'          => 'Lead',
            'contact'       => 'Contact',
            'status'        => 'Status',
            'value'         => 'Value',
        ...
        'edit' => [
            'title'         => 'Edit Client',
            'save-btn'      => 'Save Client',
            'update-success' => 'Client updated successfully.',
        ],
        'contracts' => [
            'create-success' => 'Contract/agreement created successfully.',
            'update-success' => 'Contract/agreement updated successfully.',
            'delete-success' => 'Contract/agreement deleted successfully.',
            'type-contract'  => 'Contract',
            'type-agreement' => 'Agreement',
        ],
        'slas' => [
            'create-success' => 'SLA created successfully.',
            'update-success' => 'SLA updated successfully.',
            'delete-success' => 'SLA deleted successfully.',
        ],
    ],
